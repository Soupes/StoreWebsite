        ...
        <div class="top-header-main">
            <div class="col-md-6 top-header-left">
                <div class="drop">
                    ...
                    <div class="btn-group">
                        <a class="dropdown-toggle" data-toggle="dropdown">Профиль <span class="caret"></span></a>
...
<!--start-logo-->
<div class="logo">
    <a href="<?=PATH;?>"> <img src="images/headerimage.png"></a>
</div>
<!--start-logo-->
<!--bottom-header-->
            ...
            <div class="col-md-3 header-right">
                <div class="search-bar">
                    <form action="search" method="get" autocomplete="off">
                        <input type="text" value="Поиск"onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';} class="typeahead" id="typeahead" name="s">
    ...
    <div class="container">
        <div class="infor-top">
            <div class="col-md-3 infor-left">
                ...
                <ul>
                    <li> <a href="#vk" onclick="window.open('https://vk.com/electroforez_online')"> <span class="fb"></span><h6>Вконтакте</h6></a></li>
    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="col-md-6 footer-right">
                <p>© 2020 Магазин азиатской кухни. All Rights Reserved </a> </p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
